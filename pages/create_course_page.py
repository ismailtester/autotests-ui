...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_empty_view_icon = self.page.get_by_test_id('create-course-preview-empty-view-icon')
        self.preview_empty_view_title = self.page.get_by_test_id('create-course-preview-empty-view-title-text')
        self.preview_empty_view_description = self.page.get_by_test_id('create-course-preview-empty-view-description-text')

        # Кнопка загрузки, удаления картинки предпросмотра курса и блок с информацией о загружаемой картинке
        self.preview_image_upload_icon = self.page.get_by_test_id('create-course-preview-image-upload-widget-info-icon')
        self.preview_image_upload_title = self.page.get_by_test_id('create-course-preview-image-upload-widget-info-title-text')
        self.preview_image_upload_description = self.page.get_by_test_id('create-course-preview-image-upload-widget-info-description-text')
        self.preview_image_upload_button = self.page.get_by_test_id('create-course-preview-image-upload-widget-upload-button')
        self.preview_image_remove_button = self.page.get_by_test_id('create-course-preview-image-upload-widget-remove-button')
        self.preview_image_upload_input = self.page.get_by_test_id('create-course-preview-image-upload-widget-input')

        # Форма создания курса
        self.create_course_title_input = self.page.get_by_test_id('create-course-form-title-input').locator('input')
        self.create_course_estimated_time_input = self.page.get_by_test_id('create-course-form-estimated-time-input').locator('input')
        self.create_course_description_textarea = page.get_by_test_id(
            'create-course-form-description-input'
        ).locator('textarea').first
        self.course_max_score_input = self.page.get_by_test_id('create-course-form-max-score-input').locator('input')
        self.course_min_score_input = self.page.get_by_test_id('create-course-form-min-score-input').locator('input')
        ...
        self.create_exercise_button = self.page.get_by_test_id('create-course-exercises-box-toolbar-create-exercise-button')

        # Блок, который отображется, когда в курсе нет заданий
        self.exercises_empty_view_icon = self.page.get_by_test_id('create-course-exercises-empty-view-icon')
        self.exercises_empty_view_title = self.page.get_by_test_id('create-course-exercises-empty-view-title-text')
        self.exercises_empty_view_description = self.page.get_by_test_id('create-course-exercises-empty-view-description-text')
    ...
    def check_visible_create_exercise_form(
        ...
        exercise_exercise_title_input = self.page.get_by_test_id(
            f'create-course-exercise-form-title-{index}-input').locator('input')
        ...
        expect(exercise_exercise_title_input).to_be_visible()
        expect(exercise_exercise_title_input).to_have_value(title)
    ...
    def fill_create_exercise_form(
        ...
        exercise_exercise_title_input.fill(title)
        expect(exercise_exercise_title_input).to_have_value(title)
