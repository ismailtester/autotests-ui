...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_max_score_text = self.page.get_by_test_id('course-max-score-info-row-view-text')
        self.course_min_score_text = self.page.get_by_test_id('course-min-score-info-row-view-text')
        ...
        self.course_edit_menu_item = self.page.get_by_test_id('course-view-edit-menu-item-text')
        self.course_delete_menu_item = self.page.get_by_test_id('course-view-delete-menu-item-text')
